...
\input{sections/2_background_and_rel_work.tex}
%Here, you can add the sections that you need to answer your question. 
\input{sections/3_distributed_systems.tex}
\input{sections/4_auctions.tex}
\input{sections/n_conclusion.tex}
