...
\begin{enumerate}
    \item We discuss the advantages and disadvantages of using auctions to determine function placement and execution in Section~\ref{sec:advantages} and Section~\ref{sec:disadvantages}
    \item In Section~\ref{sec:applicability}, we then evaluate applications that could potentially benefit or suffer from this approach.
\end{enumerate}
